...
a1 = Appearance.create(rating: "5", episode: Episode.new, guest: Guest.new)
a2 = Appearance.create(rating: "4", episode: Episode.new,  guest: Guest.new)
a3 = Appearance.create(rating: "3", episode: Episode.new,  guest: Guest.new)